...
class Galleries extends CI_Controller {
    ...
    public function index() {
        $this->viewData['title'] = "Manage Package Galleries";
        $this->viewData['pageModule'] = 'Galleries Manager';
        $this->viewData['pageHeading'] = 'Galleries';
        $this->viewData['breadcrumb'] = array('Galleries Manager' => '');
