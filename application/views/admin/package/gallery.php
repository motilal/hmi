...
<div class="row">
    <div class="col-xs-12"> 
        <div class="box">
            <div class="col-lg-12">
                <h1 class="page-header"><?php echo isset($pageHeading) ? $pageHeading : '&nbsp;'; ?></h1>
            </div> 
            <div class="">
                <!-- The file upload form used as target for the file upload widget -->
                <form id="fileupload" action="<?php echo site_url('admin/packages/upload_gallery/' . $data->id); ?>" method="POST" enctype="multipart/form-data" accept="image/jpeg">
...
<script id="template-download" type="text/x-tmpl"> 
    ...
    <input type="checkbox" name="delete" value="1" class="toggle toggle-single">
    {% } else { %}
    <button class="btn btn-cancel-image cancel"> 
    </button>
    {% } %}
...
<script>
    var uploadUrl = SITE_URL + 'admin/packages/upload_gallery/<?php echo $data->id; ?>';
</script>
